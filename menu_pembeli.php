...
<html lang="en">
  ...
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          ...
          <hr>
          <p class="lead font-weight-bold">Mie terpedas di indonesia no.2</p>
        </div>
      </div>
  <!-- Akhir Jumbotron -->
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="user.php">Jago nya Mie</a>
  ...
  <!-- Akhir Navbar -->
<div class="container">
        <a href="best_seller.php" class="btn btn-success mt-3">Menu Best Seller</a>
        <div class="row">
